  ...
  return (
    <div className="flex items-center gap-2">
      <input
        ...
        placeholder="e.g. LHR"
        className="w-28 rounded-lg border border-line px-2 py-1.5 text-sm text-content placeholder:text-faint"
      />
      <input
        type="number"
        min={0}
        ...
        className="w-16 rounded-lg border border-line px-2 py-1.5 text-center text-sm text-content placeholder:text-faint"
        placeholder="0"
      />
